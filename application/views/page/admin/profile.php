...
<head>
    ...
    function clearInputs() {
        // Menghapus nilai dari beberapa input fields
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-5 mt-10">
            <div class="flex flex-col lg:flex-row mx-auto max-w-7xl py-6 px-4 lg:px-0">
                ...
                <?php
// Contoh pengisian variabel dari database (gunakan model dan query yang sesuai)
$username = "username";
$email = "email";
$firstName = "firstName";
$lastName = "lastName";
                    ...
                    <div class="bg-white rounded-lg shadow-md p-4">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            <div class="mb-4">
                                ...
                                <input type="text" class="border rounded-md w-full p-2" value="<?= $username ?>"
                                    id="username" name="username" onclick="this.value = '';">
                            </div>
                            <div class="mb-4">
                                <label for="email" class="block mb-1 text-sm">Email address</label>
                                <input type="text" value="<?= $email ?>" class="border rounded-md w-full p-2" id="email"
                                    name="email" onclick="this.value = '';">
                            </div>
                            <div class="flex flex-col lg:flex-row lg:gap-4 mb-4">
                                <div class="w-full lg:w-1/2 mb-4 lg:mb-0">
                                    <label for="firstName" class="block mb-1 text-sm">First name</label>
                                    <input type="text" class="border rounded-md w-full p-2" value="<?= $firstName ?>"
                                        id="firstName" name="firstName" onclick="this.value = '';">
                                </div>
                                <div class="w-full lg:w-1/2">
                                    <label for="lastName" class="block mb-1 text-sm">Last name</label>
                                    <input type="text" class="border rounded-md w-full p-2" value="<?= $lastName ?>"
                                        id="lastName" name="lastName" onclick="this.value = '';">
                                </div>
                            </div>
                            <div class="mb-4">
